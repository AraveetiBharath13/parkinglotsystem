...
public class Main {
    public static void main(String[] args) throws InterruptedException, SpotNotFoundException {
        ...
        floor3.addSpot(new ParkingSpot("F3-S2", SpotType.LARGE));
        lot.addFloor(floor3);
       ...
       // lot.changeStrategy(new RandomSpotStrategy());
        ...
        Vehicle truck3 = new Vehicle("KA-78-7777", VehicleType.TRUCK);
        ParkingTicket t7 = lot.getEntryPanel().parkVehicle(truck3, lot);
